...
export function getPopupCustomCSSProperites(element: HTMLElement) {
  ...
  return {
    offset: parseTokenNumber(styles.getPropertyValue('--nve-sys-layer-popup-offset')),
    arrowOffset: parseTokenNumber(styles.getPropertyValue('--nve-sys-layer-popup-arrow-offset')),
    arrowPadding: parseTokenNumber(styles.getPropertyValue('--nve-sys-layer-popup-arrow-padding'))
  };
}
