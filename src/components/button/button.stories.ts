...
export const Default = {
  render: (args: ArgTypes) => html`<nve-button data-testid="button" label=${args.label} iconButtonTooltip=${args.iconButtonTooltip} variant=${args.variant} ?disabled=${args.disabled} icon=${args.icon} iconplacement=${args.iconPlacement}>${args.content}</nve-button>`,
