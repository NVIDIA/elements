...
function template(theme: '' | 'dark' = ''): string {
  return /* html */ `
    ...
    <section nve-layout="column gap:sm" style="width: 240px; background: var(--nve-sys-layer-container-background)">
      <div nve-layout="column gap:sm pad:sm">
        ...
        <h2 nve-text="heading lg" style="width: 100%"><nve-format-truncate position="center">training-pipeline-2026-08-05-production</nve-format-truncate></h2>
