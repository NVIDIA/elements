...
import type { Matrix4, Vec3, Vec4 } from '../../internal/types.js';
...
function multiplyVec4(matrix: Matrix4, vector: Readonly<Vec4>): [number, number, number, number] {
  return [
...
function readMatrix(matrix: Matrix4, index: number): number {
