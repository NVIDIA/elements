...
export function oitTargetStates(): readonly SceneGPUColorTargetState[] {
  return [
    {
...
export function createOitCompositePipeline(
  device: SceneGPURenderPipelineDevice,
  format: string
): SceneGPURenderPipeline {
