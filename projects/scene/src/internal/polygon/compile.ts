...
// eslint-disable-next-line complexity, max-lines-per-function, max-statements -- @hotpath This O(n²) triangulation hot path keeps its mutable state local and allocation-free per candidate.
...
// eslint-disable-next-line complexity, max-params -- @hotpath This polygon-validation inner loop avoids allocating endpoint-pair wrappers.
...
// eslint-disable-next-line max-params -- @hotpath This ear-clipping inner loop avoids allocating a triangle wrapper per candidate.
