...
/**
 * @summary Define indexed, lit mesh geometry once and reuse it with instance transforms. Use for persistent robot or environment assets that need normals, textures, or efficient instancing.
 */
export const Default = {
  render: () => html`
    <nve-scene aria-label="example mesh">
      ...
      <nve-scene-mesh id="example-mesh" source='[{"position":[-1.25,0,0.6],"color":"cyan"},{"position":[1.25,0,0.6],"orientation":[0,0,0.382683,0.92388],"scale":[0.75,0.75,1.25],"color":"magenta"}]'>
      </nve-scene-mesh>
      <script type="module">
