...
describe('scene labels visual runtime', () => {
  test.each(['', 'dark'] as const)('renders current and explicit colors with the %s theme', async theme => {
...
function template(theme: '' | 'dark'): string {
  return `<script type="module">
    ...
    labels.add({ text: 'ORIGIN', position: [0, 0, 0], scale: 36 });
  ...
  <nve-scene aria-label="labels" style="width:512px;height:512px">
