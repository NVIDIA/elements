 ...
 * @event {ScenePickHit} nve-scene-click - Dispatched when pointer activation resolves to this marker.
 * @event {ScenePickHit} nve-scene-pointerenter - Dispatched when the pointer enters this resolved marker.
 * @event {ScenePickHit} nve-scene-pointerleave - Dispatched when the pointer leaves this resolved marker.
 * @stable false
 */
