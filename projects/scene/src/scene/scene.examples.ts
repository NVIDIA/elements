  ...
  render: () => html`
    <nve-scene aria-label="scene component showcase">
      ...
      <nve-scene-frame position="[5,2.5,0]">
        <nve-scene-label position="[0,0,8]" anchor="bottom"><span>simple rover</span></nve-scene-label>
        <nve-scene-model>
    ...
    <script type="module">
      import { LineVertexBuffer, PointBuffer, TriangleVertexBuffer } from '@nvidia-elements/scene';
      import '@nvidia-elements/scene/scene/define.js';
      import '@nvidia-elements/scene/camera/define.js';
      import '@nvidia-elements/scene/cubes/define.js';
      import '@nvidia-elements/scene/spheres/define.js';
    ...
    <main nve-layout="column align:vertical-center full">
      <div nve-layout="grid gap:sm span-items:6 align:vertical-center">
        <nve-scene id="lerobot-replay-scene" role="region" aria-label="LeRobot SO-100 episode replay" style="width: 100%; min-width: 0; min-height: 0; aspect-ratio: 4 / 3;">
          ...
          <nve-scene-camera behavior="orbit" target="[1.1,0,0.4]" distance="7" phi="0.001" theta="0" projection="ortho" frustum-height="4.1" min-distance="2.5" max-distance="12"></nve-scene-camera>
