...
/**
 * @summary Replay LeRobot SO-100 joint motion beside the synchronized top-camera video. Use this pattern to compare a reconstructed arm pose with the robot's physical behavior.
 * @tags pattern
 */
export const EpisodeReplay = {
  render: () => html`
  <nve-page id="lerobot-episode-replay">
    <main nve-layout="column align:vertical-center full">
      <div nve-layout="grid gap:sm span-items:6 align:vertical-center">
        <nve-scene id="lerobot-replay-scene" role="region" aria-label="LeRobot SO-100 episode replay" style="width: 100%; min-width: 0; min-height: 0; aspect-ratio: 4 / 3;">
          <nve-scene-gridlines count="20" spacing="0.4"></nve-scene-gridlines>
          <nve-scene-camera behavior="orbit" target="[1.1,0,0.4]" distance="7" polar-angle="0.001" azimuth="0" projection="orthographic" frustum-height="4.1" min-distance="2.5" max-distance="12"></nve-scene-camera>
          <nve-scene-model aria-label="Observed SO-100 follower arm">
            <nve-scene-part shape="cube" position="[0,-0.43,0.08]" scale="[1.1,0.1,0.16]" color="#d97736"></nve-scene-part>
            <nve-scene-part shape="cube" position="[0,0.43,0.08]" scale="[1.1,0.1,0.16]" color="#d97736"></nve-scene-part>
            <nve-scene-part shape="cube" position="[-0.5,0,0.08]" scale="[0.1,0.86,0.16]" color="#d97736"></nve-scene-part>
            <nve-scene-part shape="cube" position="[0.5,0,0.08]" scale="[0.1,0.86,0.16]" color="#d97736"></nve-scene-part>
            <nve-scene-part shape="cube" position="[0.12,0,0.35]" scale="[0.72,0.68,0.56]" color="#e8eaed"></nve-scene-part>
            <nve-scene-part shape="cube" position="[0.12,-0.34,0.35]" scale="[0.84,0.1,0.48]" color="#d97736"></nve-scene-part>
            <nve-scene-part shape="cube" position="[0.12,0.34,0.35]" scale="[0.84,0.1,0.48]" color="#d97736"></nve-scene-part>
            <nve-scene-part shape="cube" position="[0.388,0,0.42]" scale="[0.454,0.248,0.396]" color="#30343b"></nve-scene-part>
            <nve-scene-part shape="cylinder" position="[0.388,0,0.62]" scale="[0.24,0.24,0.08]" color="#aeb4be"></nve-scene-part>
            <nve-scene-part shape="cube" position="[-0.32,0.3,0.18]" scale="[0.36,0.22,0.24]" color="#20242a"></nve-scene-part>
          </nve-scene-model>
          <nve-scene-frame id="lerobot-joint-0" name="shoulder_pan">
            <nve-scene-model>
              <nve-scene-part shape="cube" position="[-0.151996,-0.091389,-0.271]" orientation="[0.49381,-0.821293,0,0.28571]" scale="[0.5,0.3,0.56]" color="#e8eaed"></nve-scene-part>
              <nve-scene-part shape="cylinder" position="[-0.095,-0.18,-0.27]" orientation="[0.49381,-0.821293,0,0.28571]" scale="[0.035,0.035,0.54]" color="#a52a2a"></nve-scene-part>
            </nve-scene-model>
            <nve-scene-frame id="lerobot-joint-1" name="shoulder_lift">
              <nve-scene-model>
                <nve-scene-part shape="cube" scale="[0.454,0.248,0.396]" color="#30343b"></nve-scene-part>
                <nve-scene-part shape="cylinder" position="[0,0,0.21]" scale="[0.24,0.24,0.08]" color="#aeb4be"></nve-scene-part>
                <nve-scene-part shape="cube" position="[-0.56285,-0.14,0]" orientation="[0.170681,-0.686198,0,0.707107]" scale="[0.32,0.22,0.84]" color="#e8eaed"></nve-scene-part>
                <nve-scene-part shape="cube" position="[-0.135,-0.034,0]" orientation="[0.170681,-0.686198,0,0.707107]" scale="[0.58,0.26,0.24]" color="#e8eaed"></nve-scene-part>
                <nve-scene-part shape="cube" position="[-0.991,-0.246,0]" orientation="[0.170681,-0.686198,0,0.707107]" scale="[0.58,0.26,0.24]" color="#d97736"></nve-scene-part>
                <nve-scene-part shape="cylinder" position="[-0.54,-0.23,0.1]" orientation="[0.170681,-0.686198,0,0.707107]" scale="[0.05,0.05,0.96]" color="#20242a"></nve-scene-part>
              </nve-scene-model>
              <nve-scene-frame id="lerobot-joint-2" name="elbow_flex">
                <nve-scene-model>
                  <nve-scene-part shape="cube" scale="[0.454,0.248,0.396]" color="#30343b"></nve-scene-part>
                  <nve-scene-part shape="cylinder" position="[0,0,0.21]" scale="[0.24,0.24,0.08]" color="#aeb4be"></nve-scene-part>
                  <nve-scene-part shape="cube" position="[-0.6745,0.026,0]" orientation="[-0.027237,-0.706582,0,0.707107]" scale="[0.3,0.25,1.08]" color="#e8eaed"></nve-scene-part>
                  <nve-scene-part shape="cube" position="[-0.162,0.006,0]" orientation="[-0.027237,-0.706582,0,0.707107]" scale="[0.54,0.3,0.24]" color="#d97736"></nve-scene-part>
                  <nve-scene-part shape="cube" position="[-1.187,0.046,0]" orientation="[-0.027237,-0.706582,0,0.707107]" scale="[0.54,0.3,0.24]" color="#e8eaed"></nve-scene-part>
                  <nve-scene-part shape="cylinder" position="[-0.64,0.13,0.1]" orientation="[-0.027237,-0.706582,0,0.707107]" scale="[0.05,0.05,1.14]" color="#20242a"></nve-scene-part>
                </nve-scene-model>
                <nve-scene-frame id="lerobot-joint-3" name="wrist_flex">
                  <nve-scene-model>
                    <nve-scene-part shape="cube" scale="[0.454,0.248,0.396]" color="#30343b"></nve-scene-part>
                    <nve-scene-part shape="cylinder" position="[0,0,0.21]" scale="[0.24,0.24,0.08]" color="#aeb4be"></nve-scene-part>
                    <nve-scene-part shape="cube" position="[0,-0.3055,0.0905]" orientation="[0.598316,0,0,0.80126]" scale="[0.5,0.28,0.54]" color="#e8eaed"></nve-scene-part>
                    <nve-scene-part shape="cylinder" position="[0.15,-0.3,0.09]" orientation="[0.598316,0,0,0.80126]" scale="[0.035,0.035,0.48]" color="#a52a2a"></nve-scene-part>
                  </nve-scene-model>
                  <nve-scene-frame id="lerobot-joint-4" name="wrist_roll">
                    <nve-scene-model>
                      <nve-scene-part shape="cube" position="[0.077,0.005,-0.234]" orientation="[-0.707107,0,0,0.707107]" scale="[0.454,0.396,0.248]" color="#30343b"></nve-scene-part>
                      <nve-scene-part shape="cube" position="[-0.03,-0.002,-0.07]" scale="[0.66,0.5,0.16]" color="#30343b"></nve-scene-part>
                      <nve-scene-part shape="cube" position="[-0.17,-0.002,-0.25]" scale="[0.38,0.5,0.32]" color="#30343b"></nve-scene-part>
                      <nve-scene-part shape="pyramid" position="[-0.18,-0.002,-0.73]" orientation="[1,0,0,0]" scale="[0.3,0.48,0.64]" color="#d97736"></nve-scene-part>
                      <nve-scene-part shape="cylinder" position="[0.202,-0.245,-0.234]" orientation="[0.707107,0,0,0.707107]" scale="[0.24,0.24,0.06]" color="#e8eaed"></nve-scene-part>
                      <nve-scene-part shape="cylinder" position="[0.202,-0.28,-0.234]" orientation="[0.707107,0,0,0.707107]" scale="[0.08,0.08,0.03]" color="#20242a"></nve-scene-part>
                    </nve-scene-model>
                    <nve-scene-frame id="lerobot-joint-5" name="gripper">
                      <nve-scene-model>
                        <nve-scene-part shape="cylinder" position="[0,-0.02,0.189]" scale="[0.28,0.28,0.46]" color="#e8eaed"></nve-scene-part>
                        <nve-scene-part shape="cube" position="[0,-0.22,0.189]" scale="[0.22,0.24,0.46]" color="#e8eaed"></nve-scene-part>
                        <nve-scene-part shape="pyramid" position="[0,-0.57,0.189]" orientation="[0.707107,0,0,0.707107]" scale="[0.23,0.46,0.58]" color="#e8eaed"></nve-scene-part>
                      </nve-scene-model>
                    </nve-scene-frame>
                  </nve-scene-frame>
                </nve-scene-frame>
        ...
        <video id="lerobot-episode-video" preload="metadata" muted playsinline loop style="width: 100%; min-width: 0; min-height: 0; aspect-ratio: 4 / 3;" src="https://huggingface.co/datasets/lerobot/svla_so100_sorting/resolve/13870ca969084d8ce4d8a0391b06cead78e804ba/videos/observation.images.top/chunk-000/file-000.mp4"></video>
      </div>
    </main>
    <nve-dialog id="lerobot-episode-info" modal closable hidden>
      <nve-dialog-header>
        <h2 nve-text="heading sm medium">SO-100 episode replay</h2>
      </nve-dialog-header>
      <div nve-layout="column gap:md">
        <p nve-text="body">
          <a href="https://huggingface.co/datasets/lerobot/svla_so100_sorting/tree/13870ca969084d8ce4d8a0391b06cead78e804ba" target="_blank" rel="noreferrer">LeRobot svla_so100_sorting</a><br>
          Revision <code nve-text="code">13870ca</code> · Apache-2.0 · 30 FPS
        </p>
        <p nve-text="body muted">Joint data is bundled offline. The pinned top-camera video streams from Hugging Face. The lightweight SO-100 model uses measured proportions from the official CAD, and its motion is data-derived.</p>
      </div>
    </nve-dialog>
    <nve-page-panel slot="bottom" style="--max-height: 130px;">
      <nve-page-panel-content>
        <div class="lerobot-controls">
          <nve-media-time-range id="lerobot-frame-range" min="0" max="32.033333" step="0.033333" value="0" style="width: 100%" disabled></nve-media-time-range>
          <div nve-layout="row align:center" role="toolbar" aria-label="Episode playback controls">
            ...
            <nve-media-seek-button id="lerobot-end" action="end" disabled></nve-media-seek-button>
          </div>
          <p class="lerobot-status" nve-text="label sm semibold">
            <output id="lerobot-frame-time">Preparing offline episode data…</output>
          </p>
          <div class="lerobot-actions" nve-layout="row gap:sm align:center">
            <span nve-text="label sm">Episode timeline</span>
            <output id="lerobot-range-output" nve-text="label sm semibold">Frame 0</output>
            <nve-button size="sm" popovertarget="lerobot-episode-info" style="margin-inline-start: auto;">More info</nve-button>
          </div>
        </div>
      </nve-page-panel-content>
    </nve-page-panel>
    ...
    <script type="module">
      ...
      const end = wrapper.querySelector('#lerobot-end');
      ...
      function setPlaying(nextPlaying) {
        ...
        if (!nextPlaying) cancelVideoFrameUpdate();
      }
      ...
      function episodeLoopTime() {
        const finalFrame = expectedFrameCount - 1;
        const finalTimestamp = value(finalFrame, 0);
        const frameDuration = finalTimestamp - value(finalFrame - 1, 0);
        return finalTimestamp + frameDuration;
      }

      function schedulePlaybackFrame() {
        if (!playing || videoFrameCallback !== undefined) return;
        videoFrameCallback = video.requestVideoFrameCallback((now, metadata) => {
          ...
          if (metadata.mediaTime >= episodeLoopTime()) {
            video.currentTime = value(0, 0);
            schedulePlaybackFrame();
            return;
          }
          renderFrame(nearestFrame(metadata.mediaTime), 'playback', now);
          schedulePlaybackFrame();
        });
      }

      function seekToFrame(index) {
        const targetFrame = Math.min(expectedFrameCount - 1, Math.max(0, Math.round(index)));
        if (video.readyState === 0) {
          renderFrame(targetFrame, 'manual');
          return;
        }
        cancelVideoFrameUpdate();
        video.currentTime = value(targetFrame, 0);
        videoFrameCallback = video.requestVideoFrameCallback((now, metadata) => {
          videoFrameCallback = undefined;
          if (!playing) renderFrame(nearestFrame(metadata.mediaTime), 'manual', now);
        });
      }
      ...
      function startPlayback() {
        ...
        if (video.readyState > 0) {
          cancelVideoFrameUpdate();
          video.currentTime = value(currentFrame === expectedFrameCount - 1 ? 0 : currentFrame, 0);
          schedulePlaybackFrame();
      ...
      function scrubToRange() {
        pausePlayback();
        seekToFrame(nearestFrame(range.valueAsNumber));
      }
      ...
      restart.addEventListener('click', () => {
        ...
        pausePlayback();
        seekToFrame(expectedFrameCount - 1);
      });
  ...
  render: () => html`
    ...
    <script type="module">
      ...
      scene.addEventListener('nve-scene-click', event => {
        ...
        if (layer === markerLayer && target.kind === 'instance' && target.index === clickMarker.index) {
          clickMarker.color = markerColors[markerColorIndex];
          markerColorIndex = (markerColorIndex + 1) % markerColors.length;
          markerLayer.publish({ count: 1, start: clickMarker.index });
        }
      ...
      scene.addEventListener('nve-scene-pointerenter', event => {
        if (event.detail.layer !== markerLayer || event.detail.target.kind !== 'instance' || event.detail.target.index !== hoverMarker.index) return;
...
export const FeatureIdentity = {
  render: () => html`
    ...
    <p id="line-inspection-status" aria-live="polite" nve-text="body" nve-layout="pad-top:md">
      Select line.
    </p>
    <script type="module">
      ...
      const inspections = new Map([
        [1842, 'Line 1842 — ultrasonic inspection overdue.'],
        [2710, 'Line 2710 — inspection current.']
      ]);
      const segments = [
