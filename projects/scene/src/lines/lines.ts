...
import type { LineVertexInstanceSource } from '../internal/lines/buffer.js';
 ...
 * @stable false
 */
export class SceneLines extends StreamingLayerElement<LineVertexInstanceSource> {
  ...
  get vertices(): LineVertexInstanceSource | null {
    return this.instances;
  }

  set vertices(value: LineVertexInstanceSource | null) {
