# @nvidia-elements/lighthouse

This project provides utilities for running Lighthouse audits via Vite. This will run a series of Accessibility, Performance and Best Practice tests against each component in isolation. Due to the isolation required for the tests, the average test takes around 5-6 seconds to complete.
