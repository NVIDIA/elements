  ...
  render: () => html`
    ...
    <div class="responsive-tabs" nve-layout="pad:md">
      <nve-tabs behavior-select>
        ...
        <nve-tabs-item nve-layout="hide &sm|show">Tab 4</nve-tabs-item>
        <nve-tabs-item nve-layout="hide &sm|show">Tab 5</nve-tabs-item>
        <nve-tabs-item nve-layout="hide &sm|show">Tab 6</nve-tabs-item>
        <nve-tabs-item popovertarget="more-tabs" nve-layout="&sm|hide">
  ...
  render: () => html`
    ...
    <div class="responsive-toolbar" nve-layout="pad:md">
      <nve-toolbar>
        ...
        <nve-button container="flat" slot="suffix" nve-layout="hide &md|show">
        ...
        <nve-icon-button container="flat" slot="suffix" icon-name="gear" aria-label="Settings" nve-layout="hide &md|show"></nve-icon-button>

        <nve-icon-button container="flat" slot="suffix" icon-name="more-actions" aria-label="More actions" popovertarget="toolbar-more-actions" nve-layout="&md|hide"></nve-icon-button>
      </nve-toolbar>
