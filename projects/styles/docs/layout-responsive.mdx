...
However, we introduced an additional responsive layout module to our system that leverages [CSS Container Queries](https://developer.mozilla.org/en-US/docs/Web/CSS/@container)
...
For example, you can add conditional based gap sizing using `nve-layout="row &sm|gap:xxxs &md|gap:md &lg|gap:xxxl"`.
