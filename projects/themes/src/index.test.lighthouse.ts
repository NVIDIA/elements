...
describe('lighthouse report', () => {
  ...
  test('compact.css should remain within compressed bundle limits', async () => {
    ...
    expect(report.payload.css.kb).toBeLessThan(0.41); // total
    expect(report.payload.css.requests['compact.css'].kb).toBeLessThan(0.41);
  });
  ...
  test('debug.css should remain within compressed bundle limits', async () => {
    ...
    expect(report.payload.css.kb).toBeLessThan(0.7); // total
    expect(report.payload.css.requests['debug.css'].kb).toBeLessThan(0.7);
  });
  ...
  test('ddb-dark.css should remain within compressed bundle limits', async () => {
    ...
    expect(report.payload.css.requests['ddb.css'].kb).toBeLessThan(0.8);
  });
  ...
  test('brand-dark.css should remain within compressed bundle limits', async () => {
    ...
    expect(report.payload.css.kb).toBeLessThan(0.81); // total
    expect(report.payload.css.requests['brand.css'].kb).toBeLessThan(0.81);
  });
});
