...
import { keyNavigationGrid, useStyles, attachInternals, appendRootNodeStyle, generateId, stateScroll } from '@elements/elements/internal';
...
export class Grid extends LitElement {
  ...
  get #rows() {
    return Array.from(this.querySelectorAll<GridRow>('nve-grid-row'));
  }
