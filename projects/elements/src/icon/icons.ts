...
export const ICON_IMPORTS = {
  ...
  'ancestors': {
    svg: async () => (await import('./icons/ancestors.svg?raw')).default
  },
  'archive': {
  ...
  'color-palette': {
    svg: async () => (await import('./icons/color-palette.svg?raw')).default
  },
  'columns': {
  ...
  'inspect': {
    svg: async () => (await import('./icons/inspect.svg?raw')).default
  },
  'italic': {
  ...
  'outline': {
    svg: async () => (await import('./icons/outline.svg?raw')).default
  },
  'paper-airplane': {
  ...
  'running': {
    svg: async () => (await import('./icons/running.svg?raw')).default
  },
  'scale': {
