...
/**
 * @summary Comprehensive showcase of NVIDIA Brand Assets icons, featuring the extensive icon library available for professional applications and branding.
 * @tags test-case
 */
export const Brand = {
  render: () => html`
  ${[
    ...
    ].map(name => html`<nve-icon name=${`https://brand-assets.cne.ngc.nvidia.com/assets/icons/2.1.1/fill/${name}.svg`}></nve-icon>`)}
  `
}
