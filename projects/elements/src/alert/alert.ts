  ...
  render() {
    return html`
      <div internal-host>
        ...
        <slot></slot>
        ${this.closable ? html`<nve-icon-button @click=${() => this.#typeClosableController.close()} interaction="ghost" icon-name="cancel" .ariaLabel=${this.i18n.close}></nve-icon-button>` : ''}
      </div>
    `;
  }
