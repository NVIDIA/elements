...
/**
 * @summary Dynamic notification group with programmatic creation and stacking. Perfect for toast-style notifications generated by user actions or system events, demonstrating progressive timeout and automatic removal patterns for managing multiple notifications.
 */
...
/**
 * @summary Notification functionality within shadow DOM for web component architectures. Demonstrates proper notification positioning and behavior when used inside encapsulated component boundaries, essential for component libraries.
 * @tags test-case
 */
...
/**
 * @summary Notification z-index layering with modal dialogs demonstrating proper stacking context. Ensures notifications appear above dialogs without interfering with modal interactions, crucial for complex UI layering scenarios.
 * @tags test-case
 */
export const Layers = {
  render: () => html`
