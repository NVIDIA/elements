...
describe('mlv-breadcrumb', () => {
  ...
  it('should decorate clickable elements with flat', async () => {
    ...
    expect(element.querySelector('mlv-icon-button').container.includes('flat')).toBe(true);
    expect(element.querySelector('mlv-button').container.includes('flat')).toBe(true);
  });
