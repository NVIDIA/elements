      ...
      <div internal-host>
        <div class="header">
          ...
          ${when(
            !this.closable,
            () => html`
              <nve-icon-button part="icon-button" .container=${this.expanded ? 'flat' : undefined} icon-name="double-chevron"
            ...
            `,
            () => html`
              <nve-icon-button part="icon-button" container="flat" icon-name="cancel"
