...
export class ButtonGroup extends LitElement {
  ...
  /** The `interaction` property is intended to be used on `nve-button-group` in combination with `nve-divider` for color-coded split buttons */
  ...
  get #divider() {
    return Array.from(this.querySelectorAll<Divider>('nve-divider'));
  }
  ...
  updated(props) {
    ...
    if (this.interaction) {
      Array.from(this.querySelectorAll('nve-button')).forEach(btn => {
