...
<nve-api-summary tag="nve-steps"></nve-api-summary>
...
<nve-api-status tag="nve-steps"></nve-api-status>

<nve-api-table tag="nve-steps"></nve-api-table>

<nve-api-table tag="nve-steps-item"></nve-api-table>
