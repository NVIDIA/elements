...
<nve-api-summary tag="nve-progressive-filter-chip"></nve-api-summary>
...
<nve-api-status tag="nve-progressive-filter-chip"></nve-api-status>

<nve-api-table tag="nve-progressive-filter-chip"></nve-api-table>
