...
<section nve-layout="row gap:sm align:center">
  <nve-button>
    <a href="./?path=/docs/integrations-angular--docs&anchor=forms" onClick={() => location.reload()}>
  ...
  <nve-button>
    <a href="./?path=/docs/integrations-lit--docs&anchor=forms" onClick={() => location.reload()}>
      <svg width="20" height="20">
