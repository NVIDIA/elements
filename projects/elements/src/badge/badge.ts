...
export class Badge extends LitElement {
  ...
  render() {
    return html`
      <div internal-host>
        <slot name="prefix-icon">${!this.status?.includes('trend') && !this.color ? html`<mlv-icon name=${statusIcons[this.status]} .size=${this.#size} aria-hidden="true"></mlv-icon>` : nothing}</slot>
