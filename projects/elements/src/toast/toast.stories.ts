...
<div nve-layout="row align:center" style="height: 200px">
  <nve-toast position="top">
    default <nve-button interaction="flat">action</nve-button>
  </nve-toast>
  <nve-toast status="success" position="right">
    success <nve-button interaction="flat">action</nve-button>
  </nve-toast>
  <nve-toast status="warning" position="bottom">
    warning <nve-button interaction="flat">action</nve-button>
  </nve-toast>
  <nve-toast status="danger" position="left">
    danger <nve-button interaction="flat">action</nve-button>
  </nve-toast>
</div>
  `
};
