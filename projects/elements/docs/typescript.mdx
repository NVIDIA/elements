...
<div mlv-layout="row gap:xs">
  ...
  <mlv-button>
    <mlv-icon name="code"></mlv-icon> <a href="https://github.com/NVIDIA/elements/-/tree/main/projects/starters/typescript">Source</a>
  </mlv-button>
</div>

To use Elements in [TypeScript](https://www.typescriptlang.org/) follow the [instalation getting started](?path=/docs/about-getting-started--docs) steps.
