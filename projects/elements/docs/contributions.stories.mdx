...
3. **Implementation**: Provide a API proposal spec on the component adhering to the [coding and API guidelines](./?path=/docs/about-api-design-getting-started--docs)

4. **Code and Design Quality**: New components should maintain a high standard of code quality and adhere to the [coding and API guidelines](./?path=/docs/about-api-design-getting-started--docs)
