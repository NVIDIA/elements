...
<div mlv-layout="row gap:xs">
  ...
  <mlv-button>
    <mlv-icon name="code"></mlv-icon> <a href="https://github.com/NVIDIA/elements/-/tree/main/projects/demos/angular">Source Latest v17</a>
  </mlv-button>
  <mlv-button>
    <mlv-icon name="code"></mlv-icon> <a href="https://github.com/NVIDIA/elements/-/tree/main/projects/demos/angular-legacy">Legacy v12</a>
  </mlv-button>
</div>
...
To use elements in Angular 12 when upgrading is not possible, the [static import bundles](https://github.com/NVIDIA/elements/-/tree/main/projects/demos/static?ref_type=heads) can be copied into the Angular CLI assets and referenced.
...
```json
"assets": [
  "@elements/elements/bundles/elements.0.30.0.bundle.css",
  "@elements/elements/bundles/elements.0.30.0.bundle.js"
]
```
