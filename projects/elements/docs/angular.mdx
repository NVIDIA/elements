...
<div nve-layout="row gap:xs">
  ...
  <nve-button>
    <nve-icon name="code"></nve-icon> <a href="https://github.com/NVIDIA/elements/-/tree/main/projects/demos/angular">Source Latest v17</a>
  </nve-button>
  <nve-button>
    <nve-icon name="code"></nve-icon> <a href="https://github.com/NVIDIA/elements/-/tree/main/projects/demos/angular-legacy">Legacy v12</a>
  </nve-button>
</div>
...
<nve-alert-group status="danger">
  <nve-alert>Angular 12 is past its support lifecycle and will not receive security updates. Applications should migrate as soon as possible to the <a href="https://angular.dev/update">latest release</a>.</nve-alert>
</nve-alert-group>
...
<nve-alert status="accent">Imports like Webpack !raw-loader and Vite ?inline are not Web standard and likely to be migrated in the future to <a href="https://web.dev/css-module-scripts/">Import Assertions</a></nve-alert>
