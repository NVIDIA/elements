...
Due to Angular 12 using a outdated version of Webpack and ESBuild that do not support standard CSS and JavaScript language features. The latest current version of Elements that Angular 12 supports is `0.20.0`.
