...
<div nve-layout="row gap:xs">
  ...
  <nve-button>
    <nve-icon name="code"></nve-icon> <a href="https://github.com/NVIDIA/elements/-/tree/main/projects/starters/angular">Source Latest v17</a>
  </nve-button>
  <nve-button>
    <nve-icon name="code"></nve-icon> <a href="https://github.com/NVIDIA/elements/-/tree/main/projects/starters/angular-legacy">Legacy v12</a>
  </nve-button>
</div>
