...
<nve-alert status="muted"><p>🎓 Learn: <a href="https://justinfagnani.com/2019/11/01/how-to-publish-web-components-to-npm/">Publishing Web Components</a></p></nve-alert>
...
<nve-alert status="muted"><p>🎓 Learn: <a href="./?path=/story/about-extensions--page#scoped-registry">Elements Documentation</a></p></nve-alert>

<nve-alert status="muted"><p>🎓 Learn: <a href="https://github.com/webcomponents/polyfills/tree/master/packages/scoped-custom-element-registry">Scoped Element Registry</a></p></nve-alert>

<nve-alert status="muted"><p>🎓 Learn: <a href="https://www.youtube.com/watch?v=QmDToR6mLhk">Case Study</a></p></nve-alert>
