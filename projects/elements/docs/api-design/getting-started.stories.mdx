...
<nve-alert status="success"><p>Do: a best practice to follow</p></nve-alert>

<nve-alert status="danger"><p>Don't: a practice to avoid</p></nve-alert>

<nve-alert status="accent"><p>Tip: helpful details on rationale for a given guideline</p></nve-alert>

<nve-alert status="warning"><p>details on the risks of not following a guideline</p></nve-alert>

<nve-alert status="muted"><p>🏁 Performance: detail about how a guideline impacts performance</p></nve-alert>

<nve-alert status="muted"><p>🎓 Learn: resource to learn more about a guideline topic</p></nve-alert>

<nve-alert status="muted"><p>🚧 WIP: details on any work in progress guidance</p></nve-alert>
