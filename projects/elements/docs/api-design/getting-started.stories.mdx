...
<mlv-alert status="success"><p>Do: a best practice to follow</p></mlv-alert>

<mlv-alert status="danger"><p>Don't: a practice to avoid</p></mlv-alert>

<mlv-alert status="accent"><p>Tip: helpful details on rationale for a given guideline</p></mlv-alert>

<mlv-alert status="warning"><p>details on the risks of not following a guideline</p></mlv-alert>

<mlv-alert status="muted"><p>🏁 Performance: detail about how a guideline impacts performance</p></mlv-alert>

<mlv-alert status="muted"><p>🎓 Learn: resource to learn more about a guideline topic</p></mlv-alert>

<mlv-alert status="muted"><p>🚧 WIP: details on any work in progress guidance</p></mlv-alert>
