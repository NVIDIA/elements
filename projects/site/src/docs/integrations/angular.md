...
<nve-alert>To integrate custom form control types into Elements checkout our <a nve-text="link" href="./api/?path=/docs/foundations-forms-controls--docs&anchor=custom-controls" onClick="location.reload()">custom control</a> documentation.</nve-alert>
