...
<html lang="en" nve-theme="dark">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://esm.nvidia.com/@nvidia-elements/core@latest/dist/index.css" />
    <script type="importmap">
      {
        "imports": {
          "@nvidia-elements/core": "https://esm.nvidia.com/@nvidia-elements/core@latest",
          "@nvidia-elements/core/": "https://esm.nvidia.com/@nvidia-elements/core@latest/"
        }
      }
    </script>
