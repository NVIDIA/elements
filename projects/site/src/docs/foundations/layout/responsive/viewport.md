---
{
  ...
  description: 'Apply viewport-based responsive layouts with NVIDIA Elements media-query breakpoints, adaptive page structures, and guidance for production web interfaces.',
  layout: 'docs.11ty.js',
