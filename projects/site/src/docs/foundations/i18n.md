---
{
  ...
  description: 'Internationalization and localization patterns in NVIDIA Elements: locale formatting, right-to-left languages, and the runtime contract for components.',
  layout: 'docs.11ty.js'
}
---
