...
<nve-tree id="docs-nav" data-pagefind-ignore="all" behavior-expand>
  ...
  <nve-tree-node ${data.page.url.includes('/docs/integrations/') || data.page.url.includes('/starters/') ? 'expanded' : ''}>
    ...
    <nve-tree-node ${data.page.url.includes('/docs/integrations/hugo/') ? 'highlighted' : ''}><a href="docs/integrations/hugo/">Hugo</a></nve-tree-node>
  ...
  <nve-tree-node ${data.page.url.includes('/docs/monaco/') ? 'expanded' : ''}>
    ...
    <nve-tree-node ${data.page.url.includes('/docs/monaco/problems/') ? 'highlighted' : ''}><a href="docs/monaco/problems/">Problems</a></nve-tree-node>
  </nve-tree-node>
  ...
  <nve-tree-node ${data.page.url.includes('/docs/labs/') ? 'expanded' : ''} ${data.page.url === '/docs/labs/' ? 'highlighted' : ''}>
    ...
    <nve-tree-node ${data.page.url.includes('/docs/labs/layout/responsive/') ? 'expanded' : ''} ${data.page.url === '/docs/labs/layout/responsive/' ? 'highlighted' : ''}>
      ...
      <nve-tree-node ${data.page.url.includes('/docs/labs/layout/responsive/viewport/') ? 'highlighted' : ''}><a href="docs/labs/layout/responsive/viewport/">Viewport</a></nve-tree-node>
