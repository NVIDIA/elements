...
<div class="getting-started-page" nve-layout="column gap:xl pad-top:lg">
  ...
  <section nve-layout="column gap:lg pad-top:lg">
    ...
    <div nve-layout="grid gap:md span-items:6 &md|span-items:3 &lg|span-items:2">
      ...
      <a href="/docs/integrations/sphinx/"><nve-card class="getting-started-tile"><nve-card-content><div nve-layout="column align:center gap:sm full:height">{% svg-logo 'sphinx' %}<span nve-text="label medium">Sphinx</span></div></nve-card-content><nve-icon name="arrow" direction="right" aria-hidden="true"></nve-icon></nve-card></a>
