...
<nve-grid>
  ...
  <nve-grid-row>
    <nve-grid-cell><code nve-text="code">@nvidia-elements/code</code></nve-grid-cell>
  ...
  <nve-grid-row>
    <nve-grid-cell><code nve-text="code">@nvidia-elements/behaviors-alpine</code></nve-grid-cell>
