...
<nve-alert><nve-icon slot="icon">🎓</nve-icon> Learn:&nbsp;<a href="https://kentcdodds.com/blog/make-impossible-states-impossible" mlv-text="link">Make impossible states impossible</a></nve-alert>
...
<nve-alert status="warning"><p mlv-text="body">Warning: avoid double negations on attributes as this breaks the default expectations of native HTML elements, examples (<code mlv-text="code">disable-closable</code>, <code mlv-text="code">not-closable</code>, <code mlv-text="code">closable=”false”</code>)</p></nve-alert>
&nbsp;
<nve-alert status="warning"><p mlv-text="body">Warning: a custom coercion function is needed for react support which will set boolean attributes to a value of “false” <a href="https://github.com/vmware-clarity/core/blob/main/projects/core/src/internal/utils/dom.ts#L268" mlv-text="link">example</a> <a href="https://github.com/facebook/react/issues/9230" mlv-text="link">react issue</a>.</p></nve-alert>
...
<nve-alert status="success"><p mlv-text="body">Use <code>string | number | boolean</code></p></nve-alert>
&nbsp;
<nve-alert status="danger"><p mlv-text="body">Avoid <code>object | array</code></p></nve-alert>
...
<nve-alert status="warning"><p mlv-text="body">Warning: avoid using <code>@property</code> on built in properties/attributes on the <code>HTMLElement</code> as the decorator overrides the getter/setter and can cause unexpected behavior.&nbsp;<a href="https://github.com/vmware-clarity/core/blob/main/projects/core/build/eslint-rules/reserved-property-names.js" mlv-text="link">read more</a></p></nve-alert>
&nbsp;
<nve-alert><nve-icon slot="icon">🎓</nve-icon> <p mlv-text="body">Learn: <a href="https://developers.google.com/web/fundamentals/web-components/best-practices#attributes-properties" mlv-text="link">Web Fundamentals Attributes vs Properties</a></p></nve-alert>
