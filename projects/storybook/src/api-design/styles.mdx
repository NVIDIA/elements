...
```typescript
import theme from '@nvidia-elements/themes/dist/index.css?inline';
import layout from '@nvidia-elements/core/dist/css/module.layout.css?inline';
import typography from '@nvidia-elements/core/dist/css/module.typography.css?inline';
```
