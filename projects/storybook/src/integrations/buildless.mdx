...
<div nve-layout="row gap:xs">
  ...
  <nve-button>
    <nve-icon name="download" size="sm"></nve-icon> <a href="https://NVIDIA.github.io/elements/starters/download/buildless.zip">Download</a>
  </nve-button>
  <nve-button>
...
<nve-button><a href="https://elements-stage.nvidia.com/ui/elements-playground/91017958-e474-4f1a-9d9c-107d0ad7db8b" target="_blank">Playground</a></nve-button>
