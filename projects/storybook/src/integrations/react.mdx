...
To use Elements in [React (v19)](https://preactjs.com/) follow the [installation getting started](?path=/docs/about-installation--docs) steps. Once complete
...
To use Elements in [React v18](https://reactjs.org/) follow the [installation getting started](?path=/docs/about-installation--docs) steps. Once complete
