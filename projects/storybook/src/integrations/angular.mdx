...
<div nve-layout="row gap:xs">
  ...
  <nve-button>
    <nve-icon name="download" size="sm"></nve-icon> <a href="https://NVIDIA.github.io/elements/starters/download/angular.zip">Download</a>
  </nve-button>
  <nve-button>
    <nve-icon name="code"></nve-icon> <a href="https://github.com/NVIDIA/elements/-/tree/main/projects/starters/angular">Source</a>
  </nve-button>
</div>

To use Elements in [Angular](https://angular.dev/) follow the [installation getting started](?path=/docs/about-installation--docs) steps.
...
<nve-alert>To integrate custom form control types into Elements checkout our <a href="./?path=/docs/elements-form-control-documentation--docs&anchor=custom-controls" onClick="location.reload()">custom control</a> documentation.</nve-alert>
