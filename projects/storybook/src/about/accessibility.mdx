...
- [WCAG 2.1 AA](https://www.w3.org/TR/WCAG21/): This is the latest set of guidelines, which builds upon the previousversions and provides additional recommendations for improving accessibility.
...
of its given doceumentation page.
