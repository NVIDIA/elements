---
name: repo-testing
description: Write and run automated tests for Elements components including unit, accessibility, visual, SSR, and lighthouse tests. Use when creating test files, debugging test failures, or when the user asks about testing patterns.
---
